...
import plan from "./reel10-plan.json";
...
const msToFrame = (ms: number) => Math.round((ms / 1000) * REELS10_FPS);
...
export const makeReel = (reel: ReelPlan) => {
  ...
  const duration = Math.ceil((totalMs / 1000) * REELS10_FPS);
...
export const REELS10 = REEL_PLANS.map(makeReel);
