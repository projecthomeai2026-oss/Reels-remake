...
import plan from "./reel8-plan.json";
...
const msToFrame = (ms: number) => Math.round((ms / 1000) * REELS8_FPS);
...
export const makeReel = (reel: ReelPlan) => {
  ...
  const duration = Math.ceil((totalMs / 1000) * REELS8_FPS);
...
export const REELS8 = REEL_PLANS.map(makeReel);
